...
public class CsvStreamReaderTest {
    ...
    public void example1_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example1_utf8_unix.csv").toURI());

        Assertions.assertEquals(CsvTestData.FILE1_UNIX, CharacterUtil.toCodePoints(file, StandardCharsets.UTF_8));

        final CsvStreamReader reader = new CsvStreamReader(Files.newInputStream(file.toPath(), StandardOpenOption.READ),
                false, StandardCharsets.UTF_8, CsvUtil.DEFAULT_VALUE_SEPARATOR, 0, 0, 0, true);

        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE1);
    }

    @Test
    public void example1_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example1_utf8_mac.csv").toURI());
    ...
    public void example1_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example1_utf8_win.csv").toURI());
    ...
    public void example2_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example2_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE2);
    }

    @Test
    public void example2_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example2_utf8_mac.csv").toURI());
    ...
    public void example2_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example2_utf8_win.csv").toURI());
    ...
    public void example3_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example3_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE3);
    }

    @Test
    public void example3_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example3_utf8_mac.csv").toURI());
    ...
    public void example3_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example3_utf8_win.csv").toURI());
    ...
    public void example5_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example5_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE5);
    }

    @Test
    public void example5_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example5_utf8_mac.csv").toURI());
    ...
    public void example5_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example5_utf8_win.csv").toURI());
    ...
    public void example6_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example6_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE6_UNIX);
    }

    @Test
    public void example6_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example6_utf8_mac.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE6_MAC);
    }

    @Test
    public void example6_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example6_utf8_win.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE6_WIN);
    }

    @Test
    public void example7_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example7_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE7);
    }

    @Test
    public void example7_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example7_utf8_mac.csv").toURI());
    ...
    public void example7_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example7_utf8_win.csv").toURI());
    ...
    public void example8_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example8_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE8);
    }

    @Test
    public void example8_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example8_utf8_mac.csv").toURI());
    ...
    public void example8_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example8_utf8_win.csv").toURI());
    ...
    public void example9_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example9_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE9);
    }

    @Test
    public void example9_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example9_utf8_mac.csv").toURI());
    ...
    public void example9_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example9_utf8_win.csv").toURI());
    ...
    public void example10_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example10_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE10);
    }

    @Test
    public void example10_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example10_utf8_mac.csv").toURI());
    ...
    public void example10_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example10_utf8_win.csv").toURI());
    ...
    public void example11a_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example11_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE11);
    }

    @Test
    public void example11a_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example11_utf8_mac.csv").toURI());
    ...
    public void example11a_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example11_utf8_win.csv").toURI());
    ...
    public void example11b_utf8_unix() throws URISyntaxException, IOException {
        ...
        final IllegalStateException ex = Assertions.assertThrows(IllegalStateException.class, () -> {
            ...
            final CsvStreamReader reader = new CsvStreamReader(
    ...
    public void example12_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example12_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE12);
    }

    @Test
    public void example12_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example12_utf8_mac.csv").toURI());
    ...
    public void example12_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example12_utf8_win.csv").toURI());
    ...
    public void example13_utf8_unix() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example13_utf8_unix.csv").toURI());
        ...
        CsvTestData.testStreamReader(reader, CsvTestData.EXAMPLE13);
    }

    @Test
    public void example13_utf8_mac() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example13_utf8_mac.csv").toURI());
    ...
    public void example13_utf8_win() throws URISyntaxException, IOException {
        final File file = new File(CsvStreamReaderTest.class.getResource("example13_utf8_win.csv").toURI());
