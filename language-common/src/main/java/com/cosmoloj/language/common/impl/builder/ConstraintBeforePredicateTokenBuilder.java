 ...
 */
public interface ConstraintBeforePredicateTokenBuilder<I extends Token>
        extends ConstraintPredicateTokenBuilder<I> {

    @Override
    default Predicate<? super I> constraint(final int historyIndex) {
        return constraintBefore(before(historyIndex));
    }

    Predicate<? super I> constraintBefore(int before);
}
