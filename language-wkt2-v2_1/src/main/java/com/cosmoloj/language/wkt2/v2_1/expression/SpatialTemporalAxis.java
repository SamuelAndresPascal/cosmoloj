 ...
 */
public class SpatialTemporalAxis extends AbstractExpression {
    ...
    public SpatialTemporalAxis(final int start, final int end, final int index, final AxisNameAbrev nameAbrev,
