...
public class Epsg1043b extends Epsg1043a {

    public Epsg1043b(final Ellipsoid ellipsoid, final double phic, final double lambda0, final double alphac,
    ...
    public static Epsg1043b ofParams(final Ellipsoid ellipsoid, final Map<MethodParameter, ?> params) {
        return new Epsg1043b(ellipsoid,
