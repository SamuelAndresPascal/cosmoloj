...
/**
 * <div>EPSG::9802</div>
 * <div class="en">Lambert Conic Conformal (2SP)</div>
 *
 * @author Samuel Andrés
 */
@Cite(Cosmoloj.IOGP_GUIDANCE_NOTE_7_2_2019)
public class Epsg9802 implements InvertibleProjection {
    ...
    public static Epsg9802 ofParams(final Ellipsoid ellipsoid, final Map<MethodParameter, ?> params) {
        return new Epsg9802(ellipsoid,
