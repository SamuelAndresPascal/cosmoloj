...
/**
 * <div>EPSG::1057</div>
 * <div class="en">Time-dependent Coordinate Frame rotation (geog2D domain)</div>
 *
...
public class Epsg1057 extends Abstract2DTo2D {

    public Epsg1057(final Ellipsoid source, final Ellipsoid target,
    ...
    public static Epsg1057 ofParams(final Ellipsoid source, final Ellipsoid target,
            final Map<MethodParameter, ?> params) {
        return new Epsg1057(source, target,
